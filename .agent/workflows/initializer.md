---
description: Initializes the project structure and feature list based on app_spec.txt
---
...
Use your native file system tools to create the files. Use your terminal tool to initialize git.
